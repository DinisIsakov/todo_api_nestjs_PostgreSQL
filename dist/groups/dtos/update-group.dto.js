...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(64, { message: 'Имя не должно превышать 64 символа' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateGroupDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Описание должно быть строкой' }),
    (0, class_validator_1.MaxLength)(256, { message: 'Описание не должно превышать 256 символов' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
